...
<BODY bgcolor = #B2F4FD>
   <H2><CENTER>Show all Rabbits Available for Adoption
   </CENTER></H2>
   <FORM METHOD="post" action="ViewAllRabbits.php">
   <P>
   <CENTER>
         ...
         <?php
            ...
            $statement = $mysqli->prepare( "SELECT * From Rabbit Where ID >= ? " );

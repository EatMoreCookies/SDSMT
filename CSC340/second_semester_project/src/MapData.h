...
class MapData
{
	...
	public:
		...
		vector<int> obstacleMap; /*!<The map of obstacles*/
		vector<int> healthMap;/*!<The map the corresponds to health of all things in the map*/
		vector<int> obsHealthMap;/*!<The map that relates to the health of obstacles*/
		vector<int> actHealthMap;/*!<The map that relates to the health of actors*/
};

...
*
* @par description:
* This function prints  how the size of the file differs after encoding
*
...
*
* @par description:
* This function prints the decoding information.
*
* @param [in] bytesRead - number of bytes read from input file
* @param [in] bytesWrite - number of bytes that we wrote to the ouput file
* @param [in] inFile - name of input file
* @param [in] outFile - name out ouput file
* @param [in] histSize - size of histogram
*
*******************************************************************************/
...
*
* @par description:
* This function decodes the file by following the bit strings in the huff to find
* that character. It then prints it to the file
*
* @param [in,out]  fin -  a file stream input object
* @param [in,out]  fout - file stream object
*
*******************************************************************************/
void heap::decodeFile ( istream &fin, ofstream &fout )
{
    unsigned char ch;
    char toPrint;
    int bitCounter = 0;
    ...
    while (fin.read((char*) &ch, 1 ) )
    {
	    ...
	    //if we find the character print it
...
*
* @par description:
* This functions finds the character that the huff code refers to. It does this by
* traversing the tree until a character is found.
*
* @param [in,out]  node - huffNode pointer
* @param [in]      direction - says whether to go right or left
* @param [in,out]  ch - character that will print when we find one in the tree
*
* returns true  - character found
* returns false - character not found 
*
*******************************************************************************/
bool heap::findChars (huffNode *&node, int direction, char &ch )
{
	...
	//found a leaf node that contains a character
        if (node->leftchild == nullptr && node->rightchild == nullptr )
        {
             ch = node->ch;
